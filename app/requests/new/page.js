...
export default function NewRequest() {
  ...
  const calculateFinalAmount = () => {
    ...
    // Calculate expected check amounts
    const expectedCheckWithFee = numAmount + fee
    const expectedCheckWithoutFee = numAmount
    
    // Determine if fee is included by checking which expected amount is closer
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">${calculations.fee.toFixed(2)}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              <span>Bank Fee:</span>
              <span className="font-medium">${calculations.bankFee.toFixed(2)}</span>
            </div>
            <div className="flex justify-between">
