    ...
    <div className="py-12 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-3xl font-semibold mt-2">{stats.totalRequests}</p>
          <div className="mt-2 text-sm text-green-600">+12 from last week</div>
        </div>

        {/* Total Cash Processed Card */}
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-gray-500 text-sm font-medium">Total Cash Processed</h3>
          <p className="text-3xl font-semibold mt-2">{stats.totalProcessed}</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-3xl font-semibold mt-2">{stats.totalProfit}</p>
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="divide-y divide-gray-200">
          ...
          <div className="p-6 flex justify-between items-center">
            <div>
              <p className="font-medium">Check #1234</p>
              <p className="text-sm text-gray-500">Requested 2h ago</p>
            </div>
            <div className="text-right">
              <p className="font-medium">$500.00</p>
              <p className="text-sm text-gray-500">Fee: $25.00</p>
            </div>
          </div>
          <div className="p-6 flex justify-between items-center">
            <div>
              <p className="font-medium">Check #1233</p>
              <p className="text-sm text-gray-500">Requested 5h ago</p>
            </div>
            <div className="text-right">
              <p className="font-medium">$750.00</p>
              <p className="text-sm text-gray-500">Fee: $37.50</p>
            </div>
          </div>
        </div>
      </div>
