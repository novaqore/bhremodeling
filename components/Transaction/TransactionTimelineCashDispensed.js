...
const TransactionTimelineCashDispensed = ({ request, company, complete }) => {
    ...
    const handleDateSelect = (date) => {
        ...
        update(ref(db, `requests/-${request.id}`), {
            cashDispensedDate: date
        })
        setIsModalOpen(false);
    };

    const isPending = !request.cashDispensedDate;
            ...
            >
                ...
                <div className="flex-1 pt-2">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        {isPending ? 'Pending' : formatDate(request.cashDispensedDate)}
                    </p>
                    <div className="mt-2 text-sm text-gray-600">Check funds released to customer</div>
                </div>
                    ...
                    <div className="bg-white rounded-xl p-8 max-w-md w-full mx-4 shadow-2xl transform transition-all">
                        ...
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-gray-900">Cash Dispensed</h3>
                                    <p className="text-sm text-gray-500 mt-1">Set when the cash advance was provided</p>
                                </div>
                            </div>
                            <button 
                        ...
                        <div className="mb-8">
                            ...
                            <input
                                ...
                                defaultValue={request.cashDispensedDate || ''}
                            />
                        </div>
...
export default TransactionTimelineCashDispensed;